...
export default function FlightResults() {
  ...
  const { data: flights, loading, error } = useApi('/flights/search', {
    method: 'POST',
  ...
  return (
    <div className="max-w-6xl mx-auto">
      <div className="mb-8">
        ...
        <h1 className="text-3xl font-bold text-gray-900 mt-4">Available Flights</h1>
        <p className="text-gray-600 mt-2">
          {state.searchParams.origin} to {state.searchParams.destination} on {state.searchParams.departureDate}
        </p>
      </div>
