              ...
              {[
                ...
                >
                  <input
                    ...
                    value={method.value}
                    checked={
                      state.bookingDetails.paymentMethod === method.value
                    }
                    onChange={(e) =>
                      dispatch({
              ...
              <div className="mb-6">
                <div className="flex justify-between items-start mb-4">
                  ...
                  <div className="text-right">
                    <p className="font-bold text-gray-900">
                      {state.selectedFlight.originAirport}
                    </p>
                    <p className="text-sm text-gray-500">to</p>
                    <p className="font-bold text-gray-900">
                      {state.selectedFlight.destinationAirport}
                    </p>
                  </div>
                </div>
                <div className="text-sm text-gray-600 mb-4">
                  <p>
                    Departure:{" "}
                    {new Date(
                      state.selectedFlight.departureTime
                    ).toLocaleString()}
                  </p>
                ...
                <div className="border-t pt-4">
                  <div className="flex justify-between mb-2">
                    ...
                    <span
                      className={
                        state.bookingDetails.passengerName
                          ? "font-medium"
                          : "text-red-500"
                      }
                    >
                  ...
                  <div className="flex justify-between mb-2">
                    ...
                    <span
                      className={
                        state.bookingDetails.passengerEmail
                          ? "font-medium"
                          : "text-red-500"
                      }
                    >
                  ...
                  <div className="flex justify-between mb-2">
                    ...
                    <span
                      className={
                        state.bookingDetails.passengerPhone
                          ? "font-medium"
                          : "text-red-500"
                      }
                    >
                  ...
                  <div className="flex justify-between mb-2">
                    ...
                    <span>
                      ...
                      {state.selectedFlight.price
                        ? state.selectedFlight.price.toFixed(2)
                        : "0.00"}{" "}
                ...
                <div className="flex">
                  ...
                  <div className="ml-3">
                    <p className="text-sm text-yellow-700">
                      Please complete all required fields to proceed with your
                      booking.
                    </p>
                  </div>
                </div>
