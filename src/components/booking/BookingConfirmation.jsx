...
const { data: booking, loading, refetch } = useApi(`/bookings/${bookingReference}`);
...
const isPaymentPending = paymentStatus === 'PENDING'; // Add this line
...
<p className="text-lg text-gray-600">Your booking could not be completed</p>
</>
) : (
<>
...
<p className="text-lg text-gray-600">Please wait while we process your payment</p>
<div className="mt-4">
...
<p className={`text-lg font-bold ${
isPaymentCompleted ? 'text-green-600' :
...
isPaymentCompleted ? 'bg-blue-50' :
isPaymentFailed ? 'bg-red-50' : 'bg-yellow-50'
}`}>
<h3 className="text-lg font-bold text-gray-900 mb-2">
{isPaymentCompleted ? 'Next Steps' :
isPaymentFailed ? 'What to do now' : 'Processing Payment'}
</h3>
...
{isPaymentFailed && (
<p className="text-gray-600 mb-4">
We were unable to process your payment. Your booking has been cancelled.
Please try booking again or contact support if the problem persists.
</p>
)}

{isPaymentPending && (
<p className="text-gray-600 mb-4">
We're currently processing your payment. This usually takes less than a minute.
